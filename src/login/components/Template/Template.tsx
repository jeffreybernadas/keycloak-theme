/**
 * This file has been claimed for ownership from @oussemasahbeni/keycloakify-login-shadcn version 250004.0.11.
      ...
      <div className='bg-slate-950 relative hidden lg:block dark:bg-white/5'>
        <div className='flex items-center pt-20 h-full justify-center z-1'>
          ...
          <div className='flex justify-center my-auto flex-col items-center max-w-xs'>
            <div className=' mb-4 flex items-center gap-3'>
              <img src={branding.logo} alt='Logo' className='h-10 w-auto' />
              <span className='text-white text-xl'> {branding.name}</span>
            </div>
            ...
            {branding.projectsUrl && (
              <a
                href={branding.projectsUrl}
                target='_blank'
                rel='noopener noreferrer'
                className='mt-4 inline-flex items-center gap-1.5 text-sm text-blue-400 hover:text-blue-300 transition-colors underline underline-offset-2'
              >
                View my projects
                <svg
